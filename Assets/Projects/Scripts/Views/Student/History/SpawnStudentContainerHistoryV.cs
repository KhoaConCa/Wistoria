...
public class SpawnStudentContainerHistoryV : MonoBehaviour, IHistoryStudentViewSpawner
{
    #region -- Implements --
    ...
    public void CreateContainer(string dateTime, List<HistoryDStudent> histories)
    {
        GetComponentDefault();
    ...
    private void GenerateContainerPrefab(string objectDateTime, List<HistoryDStudent> histories)
    {
    ...
    private IHistoryContainerDStudent _containerData;
